...
class Command(BaseCommand):
    ...
    def _creer_trip(self, today, d, a_la_une):
        ...
        trip = AgroTrip.objects.create(
            ...
            date_fin=date_fin,
            prix=d["prix"],
            prix_simple=d["prix"] if a_la_une else 0,
            prix_couple=round(d["prix"] * 1.8 / 1000) * 1000 if a_la_une else 0,
            prix_familiale=round(d["prix"] * 3 / 1000) * 1000 if a_la_une else 0,
